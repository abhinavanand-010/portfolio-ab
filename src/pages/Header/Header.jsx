...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full bg-gray-900/95 backdrop-blur-md md:bg-transparent md:backdrop-blur-none">
      <div className="w-full md:fixed md:top-4 md:left-1/2 md:transform md:-translate-x-1/2 md:w-auto">
        <div className="p-[2px] md:rounded-full bg-gradient-to-r from-emerald-400 via-cyan-500 to-indigo-500 animate-gradient-x">
          <nav className="bg-gray-900/90 backdrop-blur-md md:rounded-full px-4 md:px-6 py-2.5">
            ...
            <div className={`${isMenuOpen ? 'block' : 'hidden'} md:block`}>
              <div className="flex flex-col gap-2 py-4 md:flex-row md:items-center md:gap-1 lg:gap-2 md:py-0">
